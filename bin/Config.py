...
class Config:
    ...
    def __init__(self, kmer_size=31, rand_lkp=False, dist=0, min_smp_sz=20, max_smp_sz=50, lmer_size=7,
        jsthrsh=0.05, q_thresh=0.1, batch_sz_poibin=10000, max_fastq_reads=0, annot_fasta=[]):
